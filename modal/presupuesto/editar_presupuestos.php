	            ...
	            <div class="modal-body">
	                <form class="form-horizontal" method="post" id="editar_presupuesto" name="editar_presupuesto">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8 input-group date" id="fecha" data-target-input="nearest">
	                            <input type="text" class="form-control datetimepicker-input" data-target="#fecha"
	                                id="mod_fecha_presupuesto" name="mod_fecha_presupuesto" placeholder="Seleccionar fecha"
	                                required />
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="mod_cantidad_mes_presupuesto"
	                                name="mod_cantidad_mes_presupuesto" require placeholder="0.0">
	                        </div>
	                    </div>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="mod_presupuesto_mes" name="mod_presupuesto_mes"
	                                require placeholder="0.0">
	                        </div>
	                    </div>

	                    <div class="form-group">
	                        <label for="mod_cantidad_promos_presupuesto" class="col-sm-3 control-label">Cantidad
	                            Promos</label>
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="mod_cantidad_promos_presupuesto"
	                                name="mod_cantidad_promos_presupuesto" require placeholder="0.0">
	                        </div>
	                    </div>

	                    <div class="form-group">
	                        <label for="mod_cantidad_garantia_presupuesto" class="col-sm-3 control-label">Cantidad
	                            Garantías</label>
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="mod_cantidad_garantia_presupuesto"
	                                name="mod_cantidad_garantia_presupuesto" require placeholder="0.0">
	                        </div>
	                    </div>
