  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li ><a href="clientes.php" ><span class="activarnav historico activarbarra" id="historico">Histórico</span> <span class="sr-only" style="display:none">(current)</span></a></li>
